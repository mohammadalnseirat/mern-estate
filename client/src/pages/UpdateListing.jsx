...
const UpdateListing = () => {
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      ...
      // check if the data.success ===false:
  ...
  const handleChange = (e) => {
    ...
    // condition for different type of input:
    if (
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          <input
            type="text"
            placeholder="Name"
            className="border p-3 rounded-lg border-gray-400 focus:outline-none"
            id="name"
            maxLength="62"
            minLength="10"
            required
            ...
            >
              ...
              />
                <button
                  ...
                  type="button"
                  className="w-7 h-7  bg-gray-50  border-red-700 text-red-700 rounded-full text-md  hover:rotate-180 border transition-all duration-500"
                >
                  X
                </button>
              </div>
